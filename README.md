...
# Внимание, BTHome обновился до версии V2.0. Есть хорошие новости не очень (не плохие, просто потребуется делать лишние телодвижения). 
	- Наконец-то нормально заработает пакет, который содержит несколько датчиково одного типа.
	- Формат сообщения довольно-таки сильно поменялся, что потребует изменить код.
	- Изменения в BTHome вступят в силу в версии HA 2022.12.
	- Как только выйдет версия 2022.12, я все проверю и выложу изменения.
