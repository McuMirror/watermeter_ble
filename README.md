...
# Пока не торопитесь повторять. На KIT'е работает без проблем. Распаял модуль на разведенную плату - глючит. Надеюсь модуль неисправный. Жду еще партию модулей из Китая. Буду разбираться.
